...
$verTrailer.addEventListener("click" , () => {
    $contenedorTrailer.innerHTML = `<iframe class=" w-100 h-100" src="https://www.youtube.com/embed/yNXfOOL8824" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`;
})